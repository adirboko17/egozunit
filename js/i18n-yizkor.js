(function () {
  ...
  EgozI18n.register('yizkor', {
    he: {
      ...
      'search.label': 'חיפוש חלל לפי שם',
      'search.noResults': 'לא נמצאו תוצאות לחיפוש.',
      'search.results': '{count} תוצאות',
      'search.count': '{count} חללים',
      'search.countFiltered': '{shown} מתוך {total}',
      'grid.fellOn': 'נפל ב־',
      'grid.link': 'לעמוד ההנצחה',
      'grid.linkRead': 'לקריאת הסיפור',
    ...
    en: {
      ...
      'search.label': 'Search fallen by name',
      'search.noResults': 'No results found.',
      'search.results': '{count} results',
      'search.count': '{count} fallen',
      'search.countFiltered': '{shown} of {total}',
      'grid.fellOn': 'Fell on ',
      'grid.link': 'Memorial page',
      'grid.linkRead': 'Read their story',
