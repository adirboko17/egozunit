(function () {
  ...
  EgozI18n.register('donate', {
    he: {
      'meta.title': 'תרומה — עמותת אגוז · הסיירת הצפונית',
      'meta.description': 'תרמו לעמותת אגוז דרך JGive — תרומה מאובטחת, קבלה לפי סעיף 46, וכל שקל מגיע ישירות לעמותה.',
      'hero.eyebrow': 'תרומה מאובטחת',
      'hero.title': 'תרמו לעמותת אגוז',
      'hero.lead': 'בוחרים סכום ומשלמים בעמוד מאובטח — כל תרומה תומכת בלוחמים, במשפחות ובפעילות העמותה.',
      'hero.img.alt': 'לוחמי אגוז',
      'section.kicker': 'תרומה',
      'section.title': 'טופס תרומה מאובטח',
    ...
    en: {
      ...
      'meta.description': 'Donate to the Egoz Association via JGive — secure payment, Section 46 tax receipt, and every shekel goes directly to the association.',
      'hero.eyebrow': 'Secure donation',
      'hero.title': 'Donate to Egoz',
      'hero.lead': 'Choose an amount and pay on a secure page — every donation supports fighters, families, and association activities.',
      'hero.img.alt': 'Egoz fighters',
      'section.kicker': 'Donation',
      'section.title': 'Secure donation form',
