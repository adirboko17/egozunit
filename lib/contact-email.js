...
function emailHtml(data) {
  ...
  const detailRow = (label, value, link) => {
    ...
    return `
      <tr>
        <td style="padding:11px 0;color:#687386;font-size:14px;width:105px;vertical-align:top">${label}</td>
        <td style="padding:11px 0;color:#13223d;font-size:15px;font-weight:600;vertical-align:top">${content}</td>
      </tr>`;
  };
...
<body style="margin:0;background:#f3f5f8;font-family:Arial,'Helvetica Neue',sans-serif;color:#13223d">
  ...
  <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#f3f5f8;padding:32px 12px">
    <tr>
      <td align="center">
        <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px;background:#ffffff;border-radius:18px;overflow:hidden;box-shadow:0 8px 30px rgba(16,37,72,.10)">
          <tr>
            <td style="padding:30px 34px;background:linear-gradient(135deg,#0b1f46,#2459a9);color:#ffffff">
          ...
          <tr>
            <td style="padding:28px 34px">
              ...
              <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="border-collapse:collapse;border-top:1px solid #e7ebf0;border-bottom:1px solid #e7ebf0">
              ...
              <div style="margin-top:24px">
                ...
                <div style="padding:18px 20px;background:#f7f8fa;border-right:4px solid #c4a86c;border-radius:10px;color:#1b2b46;font-size:15px;line-height:1.8;white-space:pre-wrap">${escapeHtml(data.message)}</div>
              </div>
